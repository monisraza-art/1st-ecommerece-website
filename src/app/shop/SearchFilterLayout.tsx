...
export default function SearchFilterLayout({
  ...
  children,
    ...
    return (
        <main className="group flex flex-col items-center justify-center gap-10 px-10 py-10 lg:flex-row lg:items-start" >
      ...
      >
       ...
       updateCollectionIds={(collectionIds) => updateFilters({collection: collectionIds})}
       />
...
function CollectionsFilter({
 collections, selectedCollectionIds,updateCollectionIds
...
function PriceFilter({minDefaultInput, maxDefaultInput, updatePriceRange}: PriceFilter) {
