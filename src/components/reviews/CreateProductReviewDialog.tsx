...
// import useMediaUpload, { MediaAttachment } from "./useMediaUploads";
...
const formSchema = z.object({
  title: z
    .string()
    .trim()
    .min(5, "Must be at least 5 chracters")
    .max(100, "Can't be longer than 100 characters")
    .or(z.literal("")),
  body: z
    .string()
    .trim()
    .min(10, "Must be at least 10 chracters")
    .max(3000, "Can't be longer than 3000 chracters")
    .or(z.literal("")),
...
//       className={cn(
//         "relative size-fit",
//         state === "failed" && "outline-destructive outline outline-1",
//       )}
//     >
