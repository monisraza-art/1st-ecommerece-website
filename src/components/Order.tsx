...
export default function Order({order}: OrderProps) {
    ...
    const paymentMethodStatusMap: Record<orders.PaymentStatus, string> = {
        ...
        [orders.PaymentStatus.PARTIALLY_REFUNDED]: "Partially paid",
        ...
        [orders.PaymentStatus.DECLINED]: "No information",
        [orders.PaymentStatus.PENDING_MERCHANT]: "No information",
    }
    ...
    ?paymentMethodStatusMap[order.paymentStatus]
    : null
    ...
    return <div className="w-full space-y-5 border p-5" >
